...
contract GalileiBlockReward is BlockReward {
    ...
    uint256 constant HF1_BLOCK = 1000;
    ...
    function getBlockPosition()
        ...
        returns (uint256)
    {
        if (block.number < 1500) {
            return 0;
        } else if (block.number < 2000) {
            return 1;
        } else if (block.number < 3000) {
            return 2;
        } else if (block.number < 4000) {
            return 3;
        }
        return 4;
    }
